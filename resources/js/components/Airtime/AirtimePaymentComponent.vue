    ...
    <table class="table table-borderless">
      <tbody>
        ...
        <tr>
          ...
          <td class="uppercase">{{ response && response.network }}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>{{ response && response.email !== "" ? response && response.email : 'Not provided' }}</td>
        </tr>
        <tr>
  ...
  methods: {
      ...
      if (navigator.onLine) {
        ...
        if (this.verifyPayload.payment_method === "VOUCHER") {
          if(this.verifyPayload.payment_ref) {
            ...
            alert('Kindly enter your voucher code')
          }
        }
    ...
    vendAirtime() {
      if(navigator.onLine) {
        ...
        AirtimeService.vend(this.verifyPayload)
          .then(response => {
    ...
    payWithCard() {
      ...
      var handler = PaystackPop.setup({
        ...
        metadata: {
          custom_fields: [
            {
              customer_phone: this.response.phone_number,
